...
Les résultats montrent une différence nette entre les groupes. Les patients non prioritaires présentent un taux de sortie plus élevé et plus concentré, correspondant à des prises en charge plus simples, tandis que les patients prioritaires ont un taux plus faible et plus étalé, reflétant des parcours plus longs et plus variables. L’estimation empirique par tranches de trente minutes confirme ces tendances et met également en évidence un effet organisationnel lié à l’heure d’arrivée, les patients arrivant tard étant incités à sortir avant la fermeture du service.

En conclusion, l’analyse théorique et empirique valide le choix de la loi Gamma pour modéliser les durées de séjour et justifie l’utilisation de paramètres distincts selon la priorité des patients, base essentielle pour les simulations ultérieures.
